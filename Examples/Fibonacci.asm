...
CHECK_FLAG:
  ...
  ADD R4, R4, #-1         ; Comapre it against 1
...
CHECK_INPUT:
  ...
  BR ITERATIVE_FIBONACCI  ; Iteratively retrieve each fibonacci number
...
END:
  ...
  OUT
  LD R0, ASCII_SPACE      ; Print a space character between each fibonacci number
  OUT
